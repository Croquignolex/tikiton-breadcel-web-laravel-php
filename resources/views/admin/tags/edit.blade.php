...
@section('home.body')
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ route('admin.tags.update', [$tag]) }}"
                                       ...
                                       'name' => 'fr_name', 'label' => 'fr_name'
                                        ...
                                        @component('components.input', [
                                            'type' => 'text', 'name' => 'fr_name', 'class' => 'form-control',
                                             'value' => old('fr_name') ?? $tag->fr_name, 'auto_focus' => 'autofocus'
                                            ])
                                        @endcomponent
                                    @endcomponent
                                </div>
                                ...
                                <div class="form-group">
                                    @component('components.label-input', [
                                        ...
                                        @component('components.textarea', [
                                            ...
                                            'value' => old('fr_description') ?? $tag->fr_description
                                            ])
                                        @endcomponent
                                    @endcomponent
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    @component('components.submit', [
                                       ...
                                       'title' => 'Mettre à jour cette étiquette'
                                       ])
                                    @endcomponent
                                </div>
                            </div>
