    ...
    <tr>
        <td>
            ...
            <div style="text-align: center;">
                <a href="{{ $reset_link }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #da2013; text-decoration:none;" target="_blank">
